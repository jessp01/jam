...
/* {{{ MY_AWARE_EXPORTS zend_bool php_jam_storage_unserialize(const char *, int , zval * TSRMLS_DC);
*/
MY_AWARE_EXPORTS zend_bool php_jam_storage_unserialize(const char *, int , zval * TSRMLS_DC);
/* }}} */

/* {{{ MY_AWARE_EXPORTS AwareModuleRegisterStatus php_jam_register_storage_module(php_jam_storage_module * TSRMLS_DC);
*/
MY_AWARE_EXPORTS AwareModuleRegisterStatus php_jam_register_storage_module(php_jam_storage_module * TSRMLS_DC);
/* }}} */
...
*/
#define PHP_AWARE_CONNECT_FUNC(mod_name)	AwareOperationStatus php_jam_storage_connect_##mod_name(PHP_AWARE_CONNECT_ARGS)

#define PHP_AWARE_GET_FUNC(mod_name)		AwareOperationStatus php_jam_storage_get_##mod_name(PHP_AWARE_GET_ARGS)

#define PHP_AWARE_STORE_FUNC(mod_name)		AwareOperationStatus php_jam_storage_store_##mod_name(PHP_AWARE_STORE_ARGS)

#define PHP_AWARE_GET_LIST_FUNC(mod_name)	AwareOperationStatus php_jam_storage_get_list_##mod_name(PHP_AWARE_GET_LIST_ARGS)

#define PHP_AWARE_DELETE_FUNC(mod_name)		AwareOperationStatus php_jam_storage_delete_##mod_name(PHP_AWARE_DELETE_ARGS)

#define PHP_AWARE_DISCONNECT_FUNC(mod_name)	AwareOperationStatus php_jam_storage_disconnect_##mod_name(PHP_AWARE_DISCONNECT_ARGS)
/* }}} */
